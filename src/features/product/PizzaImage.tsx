    ...
    <div className={cn('pz-flex pz-items-center pz-justify-center pz-flex-1 pz-relative pz-w-full pz-max-w-full pz-overflow-hidden', className)}>
      <img
        ...
        className={cn('pz-relative pz-left-1 pz-top-1 md:pz-left-2 md:pz-top-2 pz-transition-all pz-duration-300 pz-z-10', {
          'pz-w-[180px] pz-h-[180px] md:pz-w-[300px] md:pz-h-[300px]': size === 20,
          'pz-w-[180px] pz-h-[180px] md:pz-w-[400px] md:pz-h-[400px]': size === 30,
          'pz-w-[180px] pz-h-[180px] md:pz-w-[500px] md:pz-h-[500px]': size === 40,
        })}
      />

      <div className={cn(circleClass, 'pz-border-gray-200 pz-w-[200px] pz-h-[200px] md:pz-w-[450px] md:pz-h-[450px]')}></div>
      <div className={cn(circleClass, 'pz-border-gray-100 pz-w-[160px] pz-h-[160px] md:pz-w-[370px] md:pz-h-[370px]')}></div>
    </div>
  );
};
