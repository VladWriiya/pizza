...
export const PizzaOptions: React.FC<Props> = ({
  ...
  return (
    <>
      ...
      <div className="pz-bg-gray-50 pz-p-2 sm:pz-p-5 pz-rounded-md pz-max-h-[200px] sm:pz-max-h-[320px] pz-overflow-auto scrollbar pz-mt-2">
        <div className="pz-grid pz-grid-cols-3 pz-gap-1.5 sm:pz-gap-3">
